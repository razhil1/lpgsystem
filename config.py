...
class Config:
    ...
    NEON_DB_URL = 'postgresql://neondb_owner:npg_h5JTl0OzuZYU@ep-winter-lake-anho9gpz-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
